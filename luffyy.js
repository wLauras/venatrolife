...
client.on("ready", () => {
    client.channels.cache.get("987336357678567434").join();   
  })
...
client.on("guildMemberAdd", member => {
    ...
    let date = moment(member.user.createdAt)
       ...
       let guild = member.client.guilds.cache.get("782569087099469834")
       let log = guild.channels.cache.get("942024765202370560");
